...
namespace NotificationManagement.Presentation.Api.GRPC.SDK
{
    ...
    {
        public static IServiceCollection NotificationManagementServiceSdk(this IServiceCollection services, int grpcRetryCount, string grpcNotificationUrl)
        {
            // Http errors
            ...
            {
                options.Address = new Uri(grpcNotificationUrl);
